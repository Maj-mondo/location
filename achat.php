          ...
          <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
            ...
            <div class="newsletter_content clearfix">
              <form action="#" class="newsletter_form">
                <input type="email" class="newsletter_input" required="required" placeholder="Chercher une voiture ...">
                <button class="newsletter_button">Rechercher</button>
              </form>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row" style="box-shadow: 1px 1px 12px #999999;padding: 10px;height: 350px">
        ...
        <div class="col-xs-6 col-md-3">
         ...
         <div class="col-xs-6 col-md-3">
          <div class="button banner_button"><a href="Product.php">Acheter</a></div>
        </div>
      </div>
    </div>
