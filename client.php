        ...
        <div class="col">
          <div class="tabbed_container">
            <div class="tabs clearfix tabs-right">
              <div class="new_arrivals_title">Notre nouvel arrivage !</div>
              <ul class="clearfix">
                <li class="active">Top</li>
                <li>Véhicules particuliers</li>
      ...
      <div class="row">
        <div class="col">
          ...
          <div class="reviews_title_container">
            <h3 class="reviews_title">Nos marques</h3>
            <div class="reviews_all ml-auto"><a href="marques.php">Voir toutes les <span>marques</span></a></div>
          </div>
      ...
      <div class="row">
        <div class="col">
          <div class="viewed_title_container">
            <h3 class="viewed_title">Des chauffeurs de luxe à votre disposition</h3>
