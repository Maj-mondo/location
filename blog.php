      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="error-message">
            <h4>Désolé, nous travaillons sur le site</h4>
            <p>
Merci d'être patient. Nous travaillons sur le site et nous reviendrons sous peu.<a href="index.php">acceuil</a>.</p>
          </div>
        </div>
      </div>
    </div>
