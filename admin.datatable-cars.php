                    ...
                    <table class="table table-striped projects">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="admin.profile-car.php" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                            <a href="admin.modify-car.php" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            <a href="admin.delete.php" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
                        <tr>
                          <td>#</td>
