                    ...
                    <table class="table table-striped projects">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="agent.profile-car.php" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                            <a href="agent.modify-car.php" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            <a href="agent.delete.php" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
                        <tr>
                          <td>#</td>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="profile-car.php" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                            <a href="modify-car.php" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            <a href="delete.php" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
                        <tr>
                          <td>#</td>
